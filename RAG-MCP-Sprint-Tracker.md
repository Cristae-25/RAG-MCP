...
- [X] Write a basic `search(query, k=5)` function
...
For search.py, needed to use json.loads() to get each JSON query.

RAG Results: 

1) Query:  Beta-band coherence is diminished for visible stimuli over invisible stimuli.
Point ID:  310  Result Score:  0.5258286
Title:  Converging Intracranial Markers of Conscious Access
Text:  We compared conscious and nonconscious processing of briefly flashed words using a visual masking procedure while recording intracranial electroenceph

2) Query:  Tetraspanin-3 is a causative factor in the development of acute myelogenous leukemia
Point ID:  1910         Result Score:  0.61071026
Title:  Tetraspanin 3 Is Required for the Development and Propagation of Acute Myelogenous Leukemia.
Text:  Acute Myelogenous Leukemia (AML) is an aggressive cancer that strikes both adults and children and is frequently resistant to therapy. Thus, identifyi

3) Query:  The myocardial cell lineage originally develops from cardiac progenitors of exclusively endodermal origin.
Point ID:  518  Result Score:  0.66682094
Title:  Developmental heterogeneity of cardiac fibroblasts does not predict pathological proliferation and activation.
Text:  RATIONALE Fibrosis is mediated partly by extracellular matrix-depositing fibroblasts in the heart. Although these mesenchymal cells are reported to ha

4) Query:  Febrile seizures reduce the threshold for development of epilepsy.
Point ID:  2455         Result Score:  0.75597143
...
Text:  Febrile (fever-induced) seizures affect 3–5% of infants and young children. Despite the high incidence of febrile seizures, their contribution to the 

5) Query:  Varenicline monotherapy is more effective after 12 weeks of treatment compared to combination nicotine replacement therapies with varenicline or bupropion.
Point ID:  1939         Result Score:  0.7373191
Title:  Combination varenicline and bupropion SR for tobacco-dependence treatment in cigarette smokers: a randomized trial.
